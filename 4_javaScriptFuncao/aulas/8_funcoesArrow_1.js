//é uma boa ideia eu ter funções que fazer muito pouca coisa. Cada função fazendo uma coisa é a melhor ideia.
...
//essa sintaxe é ainda menor, porém '_' é um parâmentro, mas que pode ser ignorado nesse caso.0
ola = _ => 'Olá'
console.log(ola())