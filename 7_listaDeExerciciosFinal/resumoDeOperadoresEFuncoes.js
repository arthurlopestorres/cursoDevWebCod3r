...
// função.bind(objeto de contexto)
// function retornaParametros(...params){
//     console.log(params)
// }
...
// }
// console.log(sequencia.valor) //retorna o retun de get valor(){}
...
// Objet.values([objeto]) -> retorna array com todos os valores de cada combinação chave/valor
// Object.keys([objeto]) -> retorna array com todas as chaves de cada para chave/valor
// Object.entries([objeto]) -> retorna um array de arrays em que, cada array interno corresponde a um par chave/valor
...
//array.splice([index], [quantidade de elementos a serem excluído a partir do index], [elementos a serem adicionados a partir do i
...
//array.reduce(function('elementoAglutinador', 'elementoAtual'){retorna 'elementoAglutinador' + 'elementoAtual'}) -> serve para aglutinar elementos de um array em um só resultado final
