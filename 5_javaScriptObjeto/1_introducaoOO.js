...
function processamento(valor1, valor2, valor3){console.log(valor1, valor2, valor3)} //este é um exemplo de procedural: procedimento recebe dados, para manipulá-los *função recebe dados
...
const objeto = {
    ...
    valor2: 2,
    valor3: 3,
    processamento(){console.log(this.valor1, this.valor2, this.valor3)}
}
