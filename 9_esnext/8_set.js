...
//* precisamos acessar os elementos de um Set utilizando o mesmo método que utilizamos para o Map: 
...
//* consigo deletar elementos do set (mesma forma que no Map):
times.delete('Vasco')
console.log(times.has('Vasco')) //false
...
//? eu poderia usar um spread direto do new Set também: const listaSet = [...new Set(lista)] -> isso faria com que o passo abaixo não fosse mais necessário.
