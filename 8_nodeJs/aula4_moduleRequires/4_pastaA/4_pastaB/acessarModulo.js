...
const moduloA = require('../../../aula2/2.1_sistemaDeModulos_1') //é importante respeitar todas as letras maiusculas e minusculas no nome do arquivo, porque pode dar problemas no linux, caso não utilize corretamente. 
...
// const http = require('http') -> http é um módulo nativo do node.
